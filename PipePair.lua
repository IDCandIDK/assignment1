...
function PipePair:init(y)
    ...
    self.gapHeight = 150 - (15*spawntime)

    --****algorithm for gap height being dependent on spawn time for making the game more playable****

    --****to make this understandable - 
    --if spawntime = max = 5 seconds,gap height = min = 70
    --if spawntime = min = 2 seconds,gapheight = max = 120****
